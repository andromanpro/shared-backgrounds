...
![overview](media/backgrounds.gif)
...
Перспективная неоновая сетка убегающая к горизонту + диск солнца со стрипами + розовый ореол на горизонте + отражение. Подходит для игр, landing page'ей.
...
4 анимированные размытые blobs с вращающимся hue (0°/90°/180°/270°), каждый плавает со своей скоростью. Светлая и тёмная тема автоматически. Подходит для модных landing'ов, нейтральной атмосферы без жанровой привязки.
...
- [ ] Интегрировать Synthwave в orb-arkanoid как фон игрового поля
